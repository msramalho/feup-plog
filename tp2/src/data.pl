...
scientificField(1). % Artificial Intelligence
scientificField(2). % Computer Networks
scientificField(3). % Algorithms
scientificField(4). % Computer Graphics
scientificField(5). % Web
scientificField(6). % Software Engineering
