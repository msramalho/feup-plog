...
getJuriTimes(JuriMember):-
	performance(_, Times),
	nth1(JuriMember, Times, Time),
	retract(juriTimes(OldPTimes)),
	PTimes = [Time|OldPTimes],
	assert(juriTimes(PTimes)),
	fail.
getJuriTimes(_).
...
patientJuri(JuriMember):-
	assert(juriTimes([])),
	getJuriTimes(JuriMember),
	retract(juriTimes(PTimes)),
	nth0(_, PTimes, 120, AtLeastOne),
	nth0(_, AtLeastOne, 120).%at least two 120
*/
